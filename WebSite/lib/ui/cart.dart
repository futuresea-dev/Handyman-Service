...
class _CartScreenState extends State<CartScreen> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        padding: EdgeInsets.only(left: windowWidth*0.1, right: windowWidth*0.1, top: 20),
          child: ListView(
            shrinkWrap: true,
  ...
  _body(){
    ...
    _count = 0;
    list.add(Text(strings.get(200), /// "My Cart",
    ...
    for (var provider in providers){
      if (provider.id == "root")
        list.add(Container(
            ...
            child: Text(strings.get(206), /// Other products
      ...
      if (provider.useMinPurchaseAmount && t.subtotal < provider.minPurchaseAmount){
        list.add(Container(
            ...
            child: Text(strings.get(213) + getPriceString(provider.minPurchaseAmount),
      ...
      if (provider.useMaxPurchaseAmount && t.subtotal > provider.maxPurchaseAmount){
        list.add(Container(
            ...
            color: (theme.darkMode) ? Colors.black : Colors.white,
            alignment: Alignment.center,
            child: Text(strings.get(212) + getPriceString(provider.maxPurchaseAmount),
          ...
          margin: EdgeInsets.only(left: 20, right: 20),
            child: Row(
              children: [
                ...
                Expanded(child: button2(strings.get(201), /// "Proceed to checkout",
                    theme.mainColor, (){
                      checkoutProvider(provider);
                      _mainModel.route("checkout1");
                    }))
              ],
            )));
    ...
    if (_count == 0){
      ...
      list.add(SizedBox(height: 50,));
      list.add(Center(child: Text(strings.get(202), /// "Your cart in empty",
          style: theme.style14W800)));
    }
    ...
    return Container(
        ...
        child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(child: Column(
                    ...
                    children: [
                      ...
                      if (countAddons != 0)
                        Text("${strings.get(203)}: ", style: theme.style12W400,), /// "Addons:"
                      if (countAddons != 0)
                        SizedBox(height: 8,),
                      if (countAddons != 0)
                        addonsList(item)
              ...
              Row(
                children: [
                  Expanded(child: Text(strings.get(205), style: theme.style13W400,)), /// "Item price"
